class Solution:
    def countDaysTogether(self, arriveAlice: str, leaveAlice: str, arriveBob: str, leaveBob: str) -> int:
        ...
        leaveAliceMonth, leaveAliceDay = list(map(int, leaveAlice.split("-")))
        arriveBobMonth, arriveBobDay = list(map(int, arriveBob.split("-")))
        leaveBobMonth, leaveBobDay = list(map(int, leaveBob.split("-")))
